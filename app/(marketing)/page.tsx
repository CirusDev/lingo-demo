...
export default function Home() {
  return (
    <div className="max-w-[900px] mx-auto flex-1 w-full flex flex-col lg:flex-row items-center justify-center p-4 gap-2">
      <div className="relative w-60 h-60 lg:w-96 lg:h-96 mb-8 lg:mb-0">
        <Image 
          src={'/heros.png'}
          fill
          alt="hero"
      ...
      <div className="flex flex-col items-center gap-y-8">
        <h1 className="text-xl lg:text-3xl font-bold text-neutral-600 max-w-96 text-center">
          Learn, practice and master new languages with Lingo
        </h1>

        <div className="flex flex-col items-center gap-y-3 max-w-80 w-full">
          <ClerkLoading>
